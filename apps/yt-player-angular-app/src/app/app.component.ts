...
export class AppComponent {
    ...
    public apiMethods = [
        ...
        },
        {
            action: () =>
                this.writeToLog(
                    `getVolume() || ${this.ytPlayerService.getVolume()}`
                ),
            text: 'getVolume()',
        },
        ...
        { action: () => this.ytPlayerService.unMute(), text: 'unMute()' },
        {
            action: () =>
                this.writeToLog(
                    `isMuted() || ${this.ytPlayerService.isMuted()}`
                ),
            text: 'isMuted()',
        },
        {
        ...
        },
        {
            action: () =>
                this.writeToLog(
                    `getDuration() ${this.ytPlayerService.getDuration()}`
                ),
            text: 'getDuration()',
        },
        {
        ...
        },
        {
            action: () =>
                this.writeToLog(
                    `getState() || ${this.ytPlayerService.getState()}`
                ),
            text: 'getState()',
        },
    ];
    ...
    public onStateChange(stateChange: StateChange): void {
        this.writeToLog(
            `${StateChangeType[stateChange.type]} || Payload: ${
                stateChange.payload
            }`
        );
